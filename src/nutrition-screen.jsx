      ...
      >
        ...
        <button
          ...
          style={{
            ...
            border: 0,
            color: !value.trim() || pending ? C.textLow : C.onAccent,
...
export { Composer, ContextChip, EmptyNutrition, MessageBubble, NutritionChat, SUGGESTED_PROMPTS, ThinkingBubble, buildCheckinContext, buildContext };
